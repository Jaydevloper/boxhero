                    ...
                    <Link className='add-product__product' to={'/'}>Product List</Link>
                        ...
                        <div className='add-product__inform'>
                                ...
                                <div className='add-product__wrraper'>
                                        <button className='add-product__btn' onClick={() => setOpen(!open)} >Edit</button>
                                        <button className='add-product__btn'>Copy</button>
                                        <button className='add-product__btn' onClick={deleteClick}>Delete</button>
                                </div>
                        </div>
                            {
                                open ?
                                <>
                             <form method='PUT' action='#' onSubmit={editUser}>
                                       <div className='add-product__more-wrraper add-product__more-wrraper--open'>
                                        ...
                                        <input className='add-product__inpt' type={'text'} placeholder={"Name"} defaultValue={current.name} ref={nameRef}/>
                                    </div>
                                    <div className='add-product__more-wrraper add-product__more-wrraper--open'>
                                        <p className='add-product__more add-product__more--page'>Barcode</p>
                                        <input className='add-product__inpt' type={'text'} placeholder={"Barcode"} defaultValue={current.code} ref={codeRef}/>
                                    ...
                                    <div className='add-product__more-wrraper add-product__more-wrraper--open'>
                                        ...
                                        <input className='add-product__inpt' type={'number'} placeholder={"Purchase Price"} defaultValue={current.firstPrice} ref={firstRef}/>
                                    </div>
                                    <div className='add-product__more-wrraper add-product__more-wrraper--open'>
                                         <p className='add-product__more add-product__more--page'>Sales Price</p>
                                         <input className='add-product__inpt' type={'number'} placeholder={"Sales Price"} defaultValue={current.secondPrice} ref={secondRef}/>
                                    </div>
                                 <div className='add-product__border'>
                                    <div className='add-product__more-wrraper add-product__more-wrraper--open'>
                                        <p className='add-product__more add-product__more--page'>Type</p>
                                        <input className='add-product__inpt' type={'text'} placeholder={"Type"} defaultValue={current.text} ref={typeRef}/>
                                    </div>
                                 </div>
                                 <div className='add-product__btn-wrraper'>
                                     <button className='add-product__edit'>Edit</button>
                                    <button className='add-product__btn ' onClick={() => setOpen(false)}>Cancel</button>
                                 </div>
                            </form>
                                </>
                                :
                                ...
                                <div className='add-product__section'>
                                    <div className='add-product__more-wrraper'>
                                        <p className='add-product__more add-product__more--page'>*Name</p>
                                        <p className='add-product__more'>{current.name}</p>
                                     </div>
                                     <div className='add-product__more-wrraper'>
                                         <p className='add-product__more add-product__more--page'>Barcode</p>
                                         <p className='add-product__more'>{current.code}</p>
                                     </div>
                                     <div className='add-product__more-wrraper'>
                                         <p className='add-product__more add-product__more--page'>Purchase Price</p>
                                         <p className='add-product__more'>{current.firstPrice}</p>
                                     </div>
                                     <div className='add-product__more-wrraper'>
                                          <p className='add-product__more add-product__more--page'>Sales Price</p>
                                          <p className='add-product__more'>{current.secondPrice}</p>
                                     </div>
                                </div>
                                    <div className='add-product__more-wrraper'>
                                        <p className='add-product__more add-product__more--page'>Type</p>
                                        <p className='add-product__more'>{current.text}</p>
                                    </div>
                                    <Link className='add-product__btn add-product__btn--open' to={'/'}>Back</Link>
                                </>
                            }
                    </div>
        </div>
