        ...
        <>
            <div className="auth-page">
                    ...
                    <div className="auth-page__regis">
                            <p className="auth-page__page">Easy Sign Up</p>
                            <ul className="auth-page__list">

                            </ul>
                            <p className='auth-page__or'>or</p>
                            <Link className='auth-page__link' to={'/resignup'} >Sign up with E-mail</Link>
                        <div className='auth-page__wrraper'>
                            <p className='auth-page__txt'>Already have an account?</p>
                            <Link className='auth-page__auth' to={'/login'}>Log In</Link>
                        </div>
                    </div>
            </div>
        </>
