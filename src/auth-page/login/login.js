            ...
            <div className="auth-page">
                    <div className="auth-page__hero">
                        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="127">
                            ...
                            <p className='auth-page__title'>Easiest Inventory Management Solution</p>
                    </div>
                    <div className="auth-page__regis">
                            <p className="auth-page__page">Easy Login In</p>
                            <ul className="auth-page__list">

                            </ul>
                            <p className='auth-page__or'>or</p>
                            <Link className='auth-page__link' to={'/relogin'} > E-mail Login</Link>
                        <div className='auth-page__wrraper'>
                            <p className='auth-page__txt'>First time on BoxHero?</p>
                            <Link className='auth-page__auth' to={'/signup'}>Sign Up</Link>
                        </div>
                    </div>
            </div>
        </>
